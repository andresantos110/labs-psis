...
static const ProtobufCFieldDescriptor payperview_req__field_descriptors[5] =
{
  {
    "message_type",
    1,
    ...
    0,   /* quantifier_offset */
    offsetof(PayperviewReq, message_type),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_INT32,
    0,   /* quantifier_offset */
    offsetof(PayperviewReq, direction),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned payperview_req__field_indices_by_name[] = {
  3,   /* field[3] = ch */
  2,   /* field[2] = creditcard_number */
  4,   /* field[4] = direction */
  0,   /* field[0] = message_type */
  1,   /* field[1] = subscriber_name */
};
